...
func (n *E2EE) EncryptRequest(body []byte, raw *attestation.RawAttestation) ([]byte, *e2ee.Session, error) {
	return e2ee.EncryptChatMessagesNearCloud(body, raw.SigningKey)
}
