...
func TestHandlePinned_CacheMiss(t *testing.T) {
	...
	handler := NewPinnedHandler(
		...
		attestation.MeasurementPolicy{},
		nil /* no model RD verifier */, nil /* no RekorClient */, nil /* no NVIDIAVerifier */, nil,
	)
...
func TestNewPinnedHandler(t *testing.T) {
	...
	h := NewPinnedHandler(spkiCache, "test-key", true, allowFail, attestation.MeasurementPolicy{}, attestation.MeasurementPolicy{}, nil, nil, nil, nil)
