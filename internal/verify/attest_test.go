...
func TestVerifyNVIDIA_EmptyPayload(t *testing.T) {
	...
	eat, nras := verifyNVIDIA(ctx, raw, attestation.Nonce{}, nil, true, nil)
	if eat != nil {
...
func TestVerifyNVIDIA_WithPayload_NonJSON(t *testing.T) {
	...
	eat, nras := verifyNVIDIA(ctx, raw, attestation.Nonce{}, nil, false, nil)
	if eat == nil {
...
func TestVerifyNVIDIA_GPUEvidence_ValidNonce(t *testing.T) {
	...
	eat, nras := verifyNVIDIA(ctx, raw, nonce, nil, true, nil)
